...
const NewSurveyCreate = () => {
   ...
   // const log = (type) => console.log.bind(console, type);
    ...
    const onSubmit = async ({ formData }, e) => {
        ...
        const res = await axios.post('https://api.onchainsurveys.com/api/surveys', formData);
    ...
    const handleClick = async e => {
        ...
        const res = await axios.post('https://api.onchainsurveys.com/api/surveys', createSurvey);
